...
import info.vircletrx.agents.core.bridge.SuperblockSerializationHelper;
...
public class SuperblockLevelDBBlockStore {
     ...
     * - its only block is the genesis block from whatever Vircle network it's storing blocks from
