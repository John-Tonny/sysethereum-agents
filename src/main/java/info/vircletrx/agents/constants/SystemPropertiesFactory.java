...
import static info.vircletrx.agents.constants.SystemProperties.NO;
import static info.vircletrx.agents.constants.SystemProperties.YES;
...
public class SystemPropertiesFactory {
    ...
    public SystemProperties create() {
        try {
            ...
            String file = System.getProperty("vircletrx.agents.conf.file");
            Config cmdLineConfigFile = file != null ? ConfigFactory.parseFile(new File(file)) : ConfigFactory.empty();
            logger.info("Config ({}): user properties from -Dvircletrx.agents.conf.file file '{}'",
