...
public class MerkleRootComputer {
    ...
    public Sha256Hash computeMerkleRoot(List<Sha256Hash> hashes) {
        return computeMerkleRoot(agentConstants.getVircleParams(), hashes);
    }

    public static Sha256Hash computeMerkleRoot(AbstractVircleParams params, List<Sha256Hash> hashes) {
        // hash all the block vircleBlockHashes into a Merkle tree
